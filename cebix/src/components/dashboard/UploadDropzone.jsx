  ...
  return (
    <div>
      <label
        ...
        onDrop={handleDrop}
        className={[
          "flex cursor-pointer flex-col items-center justify-center gap-2 border px-6 py-8 text-center transition-colors",
          isDragging ? "border-accent-400 bg-accent-50" : "border-gray-200 dark:border-gray-800 bg-white dark:bg-black",
        ].join(" ")}
      >
        <span className="flex h-9 w-9 items-center justify-center border border-gray-200 dark:border-gray-800 bg-white dark:bg-black shadow-sm">
          <UploadCloud size={16} className="text-gray-500 dark:text-gray-400" />
        </span>
