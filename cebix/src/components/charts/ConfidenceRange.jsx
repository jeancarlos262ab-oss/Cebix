  ...
  return (
    <div className="w-full">
      ...
      <div className="relative mt-4 h-2.5 w-full bg-gray-100 dark:bg-gray-800">
        <div
          className="absolute top-0 h-2.5 bg-accent-400 opacity-50"
          style={{ left: `${toPct(low)}%`, width: `${toPct(high) - toPct(low)}%` }}
        />
        <div
          className="absolute top-1/2 h-4 w-4 -translate-y-1/2 -translate-x-1/2 border-2 border-white bg-accent-600 shadow"
