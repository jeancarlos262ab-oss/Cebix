...
export default function Sidebar() {
  return (
    <aside className="flex h-full w-[264px] shrink-0 flex-col border-r border-gray-200 bg-white dark:border-gray-800 dark:bg-black">
      ...
      <div className="border-t border-gray-100 py-2 dark:border-gray-800">
        ...
        >
          <span className="relative h-9 w-9 shrink-0 overflow-hidden bg-gray-200">
            <img
            ...
            />
            <span className="absolute bottom-0 right-0 h-2.5 w-2.5 border-2 border-white bg-green-500 dark:border-gray-900" />
          </span>
