    ...
    <div className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-black p-4 shadow-card">
      ...
      <div className="mt-5">
        <div className="relative h-2 w-full rounded-full bg-gray-100 dark:bg-gray-800">
          ...
          <div
            className="absolute top-1/2 w-1 -translate-x-1/2 -translate-y-1/2 rounded-full ring-2 ring-white dark:ring-black"
            style={{ left: `${clamped}%`, height: "14px", backgroundColor: active.color }}
          />
        </div>
      </div>
