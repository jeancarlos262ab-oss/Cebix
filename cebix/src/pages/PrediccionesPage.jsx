    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[280px_1px_1fr]">
        ...
        >
          ...
          <div className="border-t border-gray-200 px-4 py-6 dark:border-gray-800 sm:px-6 lg:pl-8 lg:pr-8">
            <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100">
              Variables que más influyeron
            </h2>
            <p className="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
              Contribución SHAP; el color de acento suma al rendimiento, rojo resta.
            </p>
            <div className="mt-4">
