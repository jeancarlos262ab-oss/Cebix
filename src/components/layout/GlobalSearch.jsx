    ...
    <div ref={containerRef} className="relative w-64">
      ...
      {open && query && (
        <div
          ...
          role="listbox"
          className="absolute right-0 top-full z-50 mt-1.5 max-h-80 w-80 overflow-y-auto border border-gray-200 bg-white py-1 shadow-card dark:border-gray-800 dark:bg-gray-900"
        >
          {results.length === 0 ? (
