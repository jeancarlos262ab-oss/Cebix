...
function CustomMapControls({
  ...
  return (
    <div
      className={`absolute z-10 flex flex-col gap-0.5 rounded-lg border border-slate-200 bg-white/90 p-0.5 shadow-md backdrop-blur-md dark:border-slate-700 dark:bg-slate-800/90 ${positionClasses}`}
      role="group"
    ...
    >
      ...
      {/* Separador */}
      <div className="mx-0.5 my-0.5 h-px bg-slate-300 dark:bg-slate-600" aria-hidden="true" />
  ...
  return (
    <button
      ...
      className={`flex h-8 w-8 items-center justify-center rounded-md transition-colors ${
        disabled
          ? "cursor-not-allowed bg-slate-100 text-slate-300 dark:bg-slate-700 dark:text-slate-500"
          : "bg-slate-50 text-slate-700 hover:bg-slate-100 active:bg-slate-200 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600 dark:active:bg-slate-500"
      }`}
    >
