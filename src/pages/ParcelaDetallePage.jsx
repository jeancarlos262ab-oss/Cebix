    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-6 px-8 py-6 lg:grid-cols-[1fr_360px]">
        <div>
          ...
          <div className="mt-6 grid grid-cols-3 divide-x divide-gray-200 border-y border-gray-200 dark:divide-gray-800 dark:border-gray-800">
        ...
        <div>
          ...
          <button
            ...
            className="mt-6 flex w-full items-center justify-center gap-2 bg-accent-500 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-accent-600"
          >
            <FileDown size={15} />
