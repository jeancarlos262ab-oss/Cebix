...
const ACCENTS = [
  ...
  { id: "mono", label: "Negro", swatch: "#111827" },
...
export default function AjustesPage() {
  ...
  const accentColor = ACCENTS.find((a) => a.id === accent)?.swatch ?? ACCENTS[0].swatch;
  ...
  return (
    <div className="pb-10">
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="flex items-center gap-1.5 bg-accent-500 px-3.5 py-2 text-xs font-semibold text-white shadow-sm hover:bg-accent-600"
            >
      ...
      <div className="mt-2 max-w-4xl divide-y divide-gray-200 px-8 dark:divide-gray-800">
        {/* Apariencia */}
        <SettingsSection
          icon={Palette}
          title="Apariencia"
              ...
              {ACCENTS.map((a) => (
                ...
                >
                  <span
                    ...
                    style={{ backgroundColor: a.swatch, height: "22px", width: "22px" }}
                  />
                </button>
              ))}
            </div>
        ...
        >
          ...
          <Toggle
            ...
            onChange={(v) => updateUser(account.id, { twoFactor: v })}
          />
        </SettingsSection>
      </div>
      ...
      {showEditProfile && (
        <EditProfileModal
          ...
          onSave={(fields) => updateUser(account.id, fields)}
        />
      )}
      ...
      {showChangePassword && (
        <ChangePasswordModal
          ...
          onChanged={() => updateUser(account.id, { passwordUpdatedAt: new Date().toISOString() })}
        />
      )}
    </div>
  );
